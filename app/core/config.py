...
DOCS_URL = os.getenv("DOCS_URL",
                     docs)  # disabled by default for dev set this to "/docs"
REDOC_URL = os.getenv("REDOC_URL", redoc)  # "/redoc"

# uvicorn settings
UVICORN_CONFIG_OPTIONS = os.getenv(
    "UVICORN_CONFIG_OPTIONS")  # additional json settings for uvicorn
...
LOG_LEVEL = os.getenv("LOG_LEVEL",
                      "info")  # critical, error, warning, info, debug, trace
